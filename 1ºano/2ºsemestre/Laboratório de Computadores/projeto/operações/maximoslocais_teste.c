    ...
    for(int i = 0; i < h; i++) {
      for(int j = 0; j < w; j++) {
        if(i == 0 || j == 0 || i == h-1 || j == w-1) {
         imagem2->pixel[i][j].r = imagem1->pixel[i][j].r;
         imagem2->pixel[i][j].g = imagem1->pixel[i][j].g;
         imagem2->pixel[i][j].b = imagem1->pixel[i][j].b;
        }
        else if(imagem1->pixel[i][j].g > imagem1->pixel[i-1][j].g && imagem1->pixel[i][j].g > imagem1->pixel[i+1][j].g && imagem1->pixel[i][j].g > imagem1->pixel[i-1][j-1].g && imagem1->pixel[i][j].g > imagem1->pixel[i-1][j+1].g && imagem1->pixel[i][j].g > imagem1->pixel[i+1][j-1].g && imagem1->pixel[i][j].g > imagem1->pixel[i+1][j+1].g && imagem1->pixel[i][j].g > imagem1->pixel[i][j+1].g && imagem1->pixel[i][j].g > imagem1->pixel[i][j-1].g) {
