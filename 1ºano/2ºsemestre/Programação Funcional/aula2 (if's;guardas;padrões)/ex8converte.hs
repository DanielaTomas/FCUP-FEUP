{-
  ...
  Vamos comeÃ§ar por resolver um problema mais pequeno:
  converter para texto números inferiores a 100
  (i.e., são dois algarismos).
...
-- A solução do exercício proposto ao converte6.
converte :: Int -> String
converte = converte6
------------------------------------------------------------------------
